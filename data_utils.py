...
def naive_tokenizer(sentence):
  ...
  return sentence.split() #sentence.split()
...
def create_vocabulary(vocabulary_path, data_path, max_vocabulary_size,
  ...
  if not gfile.Exists(vocabulary_path):
    ...
    with gfile.GFile(data_path, mode="r") as f:
      ...
      # print("the value of vocab_list after append: ")
      # print(vocab_list)
...
def initialize_vocab(vocabulary_path):
  ...
  if gfile.Exists(vocabulary_path):
    ...
    with gfile.GFile(vocabulary_path, mode="r") as f:
      # print(f.readlines())
      rev_vocab.extend(f.readlines()) #may need to add encoding = "utf-8"
    # print("The details of rev_vocab:")
    # print(rev_vocab)
    ...
    with gfile.GFile(data_path, mode="r") as data_file:
      with gfile.GFile(target_path, mode="w") as tokens_file:
        ...
        for line in data_file:
          ...
          # maybe this line causes the space problem. check the function of " ".join()
  ...
  if not gfile.Exists(vocabulary_path):
    ...
    with gfile.GFile(data_path, mode="r") as f:
      ...
      for line in f:
        ...
        label = line.strip()
        # if label == "infor":
        #     print("infor error generated here")
        #     print(counter)
        vocab[label] = 1
